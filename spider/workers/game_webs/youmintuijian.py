...
def get_info():
    ...
    for i in range(2):
        ...
        output_tag = ['body > div.Mid > div.Mid2 > div.Mid2_R > ul.Mid2Rtxt',
            'body > div.Mid > div.Mid2 > div.Mid2_L > div.Mid2L_con.block',
                      ]
        ...
        for i, tag in enumerate(output_tag):
            ...
            if i == 0:
                samples = result.find_elements('css selector', 'div.txt > a')
            else:
            ...
            # print('------------')
            x = 1
        element = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, '#pe100_page_pic_tu > a.p1.nexe')))
        element = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, '#pe100_page_pic_tu > a.p1.nexe')))
