...
def get_info():
    ...
    # 打开Google首页
    browser.get('https://www.gcores.com/news')
    '''
        ID = "id"
        XPATH = "xpath"
        LINK_TEXT = "link text"
    ...
    for i in range(1):
        # print('第{}轮'.format(i))
        output_tag = ['#app_inner > div.navLayout.navLayout-notCollapsed > div > div.pageContainer > div > div:nth-child(2) > div:nth-child(2) > div > div.row.row-cols-2.row-cols-md-3.row-cols-lg-4.row-cols-xxl-6',
                      ]
        id_tag = []
