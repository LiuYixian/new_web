...
def get_info():
    ...
    nums = 0
    time.sleep(2)
    next_element = browser.find_element('css selector', 'body > div.Mid > div.Mid2 > div.Mid2_L > div.Mid2L_nav > div > a:nth-child(6)')
    next_element.click()
    ...
    for i in range(2):
        ...
        for tag in output_tag:
            ...
            # print('------------')
            x = 1
        element = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, '#pe100_page_pic_tu3 > a.p1.nexe')))
