...
def get_info():
    ...
    # 打开Google首页
    browser.get('https://www.famitsu.com/search/?category=news')
    '''
        ID = "id"
        XPATH = "xpath"
        LINK_TEXT = "link text"
    ...
    for i in range(1):
        ...
        output_tag = ['body > div.l-main > div.l-story.container > div > div.col-12.col-md-12.col-lg-8 > div.row.border-col-bottom']
